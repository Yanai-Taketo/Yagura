...
/// 重大度の閾値。syslog の重大度は<b>数値が小さいほど深刻</b>（0 = 緊急〜7 = デバッグ）
...
/// </param>
/// <param name="Facility">
/// syslog PRI の facility の完全一致。<c>null</c> は条件なし。
/// PRI 自体を解析できなかった行（Facility が未設定）は対象外。
/// </param>
/// <param name="ParseStatus">
/// <see cref="Yagura.Storage.ParseStatus"/> の完全一致。<c>null</c> は条件なし。
