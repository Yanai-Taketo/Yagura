...
/// <summary>
/// Windows 統合認証での SQL Server 接続失敗の詳細（イベントログ警告 1031 の材料）。
/// </summary>
...
/// <remarks>
/// 分類の根拠は SEC-14 (a)/(c) の AD lab 実測——推測の
/// 分類表を作らない（conventions.md「技術的主張の検証」。実装を lab 実測後まで
