...
| **検証中** | Windows Server 2019（x64） | 対応とする方針ですが、実機検証の完了までは対応と表明しません（[ADR-0024](docs/adr/0024-supported-environments.md) 委任事項 1）。**この OS には TLS 1.3 がありません**（TLS を使う機能は 1.2 での通信になります） |
